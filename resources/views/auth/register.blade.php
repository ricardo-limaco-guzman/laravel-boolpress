        ...
        <div class="row">
          ...
          <div class="col-6 d-flex flex-column justify-content-center">
            ...
            <form method="POST" action="{{ route('register') }}">
              ...
              <!-- Conferma password -->
              <div class="form-group row pt-4">
                <label for="password-confirm" class="col-md-5 col-form-label text-md-right">{{ __('Conferma Password')
                  }}</label>
              ...
              <!-- Button -> register -->
              <div class="form-group row mb-0 pt-4 mt-2 justify-content-center">
                <div class="col-md-8 offset-md-0 d-flex justify-content-center">
